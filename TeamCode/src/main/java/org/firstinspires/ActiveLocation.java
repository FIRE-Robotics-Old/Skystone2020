...
public class ActiveLocation implements Runnable {
 ...
 //   private Location currentLocation;
    ...
    public void oppositeCalculation()
    {
        ...
        double angle;
        synchronized (this) {
            current_X = AutoDrivingSecondTry.convertToDistanceX(middleMotor.getCurrentPosition());
            current_Y1 = AutoDrivingSecondTry.convertToDistanceY(motorLeft.getCurrentPosition());
            current_Y2 = AutoDrivingSecondTry.convertToDistanceY(motorRight.getCurrentPosition());
